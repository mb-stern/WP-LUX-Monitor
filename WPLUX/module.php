...
class WPLUX extends IPSModule
{
    ...
    public function configureWeeklySchedule() //Wochenplaner
    {
       //Wochenplan Ereignis erstellen
        ...
        IPS_SetEventScheduleGroupPoint($EreignisID, 0, 0, 22, 30, 0, 229); //Um 22:30 Aktion mit ID 2 (=Öko) aufrufen
        IPS_SetEventScheduleGroupPoint($EreignisID, 0, 1, 8, 0, 0, 230); //Um 8:00 Aktion mit ID 0 (=Warm) aufrufen
