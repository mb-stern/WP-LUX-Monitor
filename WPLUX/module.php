...
class WPLUX extends IPSModule
{
    ...
    public function configureWeeklySchedule() //Wochenplaner
    {
       //Wochenplan Ereignis erstellen
        ...
        IPS_SetEventScheduleGroupPoint($EreignisID, 0, 1, 22, 30, 0, 229); //Um 22:30 Aktion mit ID 229
        //IPS_SetEventScheduleGroupPoint($EreignisID, 0, 0, 8, 0, 0, 230); //Um 8:00 Aktion mit ID 230
