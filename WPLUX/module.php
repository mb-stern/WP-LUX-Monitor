...
class WPLUX extends IPSModule
{
    ...
    private function calc_jaz(string $mode, float $value_out)
    {
        ...
        if ($mode == 'jaz' && $jazVisible !== 0 && IPS_VariableExists($jazVisible) && $jazfaktorVariableID !== false)
        {
            ...
            $this->SendDebug("JAZ", "Variablen zur Berechnung: start_kwh_in: ".$this->start_kwh_in." start_value_out: ".$this->start_value_out." kWh_in: ".$this->kwh_in." value_out: ".$this->value_out."", 0);
            ...
            $kwh_in_Change = $this->kwh_in - $this->start_kwh_in;
            $value_out_Change = $this->value_out - $this->start_value_out;
