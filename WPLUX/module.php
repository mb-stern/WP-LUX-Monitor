...
class WPLUX extends IPSModule
{
    ...
    public function configureWeeklySchedule() //Wochenplaner
    {
       //Wochenplan Ereignis erstellen
        ...
        IPS_SetEventScheduleAction($EreignisID, 229, "Aktiv", 0xFF0000, "FHT_SetTemperature(\$_IPS['TARGET'], 22.5);");
        IPS_SetEventScheduleAction($EreignisID, 230, "Inaktiv", 0x0000FF, "FHT_SetTemperature(\$_IPS['TARGET'], 17);");
