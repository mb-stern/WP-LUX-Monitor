        ...
        if ($hz_timerDayVisible >= 0 && $hz_timerDayVisible <= 3) 
{
    ...
    private function convertValueBasedOnID($value, $id)
    {
        ...
        switch ($id) 
        {
            case (($id >= 10 && $id <= 15) || ($id >= 16 && $id <= 28) || $id == 122 || ($id >= 136 && $id <= 137) || ($id >= 142 && $id <= 144) || ($id >= 151 && $id <= 154) || ($id >= 175 && $id <= 179) ||$id == 183 || $id == 189 || ($id >= 194 && $id <= 200) || ($id >= 208 && $id <= 209) || ($id >= 227 && $id <= 229) || ($id >= 232 && $id <= 233) || ($id >= 239 && $id <= 240)|| ($id >= 242 && $id <= 243) || $id == 267):
                $minusTest = $value * 0.1;
